...
{
    public class ABPatientDiagnosisController : Controller
    {
        ...
        // GET: ABPatientDiagnosis
        public async Task<IActionResult> Index()
        {
            var aBPatientsContext = _context.PatientDiagnosis.Include(p => p.Diagnosis).Include(p => p.Patient).OrderBy(p=>p.Patient.LastName).ThenBy(p=>p.Patient.FirstName).ThenByDescending(p=>p.DiagnosisId);
            return View(await aBPatientsContext.ToListAsync());
        }

        // GET: ABPatientDiagnosis/Details/5
        ...
        // POST: ABPatientDiagnosis/Create
        ...
        // POST: ABPatientDiagnosis/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ABPatientDiagnosis/Delete/5
        ...
        // POST: ABPatientDiagnosis/Delete/5
